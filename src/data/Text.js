export const text = {
  ...
  about: {
    ...
    img: [
      {
        src:
          'https://peter-stuhlmann-fotografie.de/wp-content/uploads/about-peter-stuhlmann.jpg',
        alt: 'Portrait von Peter Stuhlmann.',
        title: 'Portrait von Peter Stuhlmann',
        caption: 'FOTO: Peter R. Stuhlmann',
      },
    ],
    quote: {
      text:
  ...
  legalNotice: {
    ...
    tmg: {
      ...
      text:
        '<p>Peter R. Stuhlmann<br />Martha-Arendsee-Str. 10<br />12681 Berlin</p><p>Telefon: +49 (0) 1578 5630944<br />E-Mail: info@peter-stuhlmann.de</p><p> Wir sind nicht bereit oder verpflichtet, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.</p>',
    },
    disclaimerContent: {
  ...
  notFound: {
    ...
    list: {
      heading: 'Suchst Du eine der folgenden Seiten?',
      links: [
        {
          linkText: 'Portraits',
          href: '/',
